...
export const ABOUT_ME_DATA: string[] = [
  ...
  'This portfolio reflects my growth, curiosity, and the vision I’m working toward. Let’s connect and build something meaningful together.',
];

export const EXPERIENCE_DATA: IExperienceDetails[] = [
  {
